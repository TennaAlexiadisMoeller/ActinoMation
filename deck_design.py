...
def display_96well_plate_design(deck_fill_ins, assay):
    ...
    plt.savefig(dt_string + "_" + assay + "_96well_plate_design.jpg")
...
def display_15ml_falcon_rack(tubes, assay):
    ...
    dt_string = datetime.now().strftime("%Y%m%d")
    plt.savefig(dt_string + "_" + assay + "_15ml_falcon_rack_setup.jpg")
...
def display_50ml_falcon_rack(tubes, assay):
    ...
    dt_string = datetime.now().strftime("%Y%m%d")
    plt.savefig(dt_string + "_" + assay + "_50ml_falcon_rack_setup.jpg")