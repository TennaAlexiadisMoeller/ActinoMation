...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 21 09:16:35 2023
...
from actinomation.transformation import create_transformation_protocol
...
class TransformationRunner(Runner):
    ...
    def run(self, **kwargs):
        ...
        extra_lines = "\n".join([
            self.build_log_line("Plasmid name(s):" , self.plasmid_names),
            self.build_log_line("Competent cell name(s):" , self.competent_cell_names),
